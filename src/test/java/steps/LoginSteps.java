...
public class LoginSteps extends BaseSteps {
    ...
    public void iFollowLoginLinkInSideBar() {
        sideBarPage.loginLink.scrollTo().shouldBe(visible).click();
    }
    ...
    public void iSeeTheErrorMessageIsDisplayed(String expectedMessage) {
